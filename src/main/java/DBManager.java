...
public class DBManager {
    ...
    public static final String JDBC_URL_SQLite = "jdbc:sqlite:./EmbDB/liteDBAI.sqlite";


    public static final String JDBC_Driver_MySQL = "com.mysql.cj.jdbc.Driver";
    public static final String JDBC_URL_MySQL = "jdbc:mysql://localhost:3306/macchine_tpi?user=root&password=";

    public static final String JDBC_Driver_H2 = "org.h2.Driver";
    public static final String JDBC_URL_H2 = "jdbc:h2:./EmbDB/H2DBAI";
    public static final String JDBC_TCP_URL_H2 = "jdbc:h2:tcp://localhost/../EmbDB/H2DBAI";
